...
=head1 SYNOPSIS
   ...
   my $perlanet = Perlanet->new_with_traits(traits => [ 'Perlanet::Trait::FeedFile' ]);
   $perlanet->run

=head1 DESCRIPTION

When the aggregation is complete and the feed is being rendered, it will be saved to
disk in XML format.
